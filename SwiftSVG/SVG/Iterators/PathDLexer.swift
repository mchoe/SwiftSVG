...
struct ClosePath: PathCommand {
    ...
    let pathType: PathType = .absolute
...
let characterDictionary: [CChar : PathCommand] = [
    Character.M.rawValue: MoveTo(pathType: .absolute),
    Character.m.rawValue: MoveTo(pathType: .relative),
    Character.C.rawValue: CurveTo(pathType: .absolute),
    Character.c.rawValue: CurveTo(pathType: .relative),
    Character.Z.rawValue: ClosePath(),
    Character.z.rawValue: ClosePath(),
    Character.S.rawValue: SmoothCurveTo(pathType: .absolute),
    Character.s.rawValue: SmoothCurveTo(pathType: .relative),
    Character.L.rawValue: LineTo(pathType: .absolute),
    Character.l.rawValue: LineTo(pathType: .relative),
    Character.H.rawValue: HorizontalLineTo(pathType: .absolute),
    Character.h.rawValue: HorizontalLineTo(pathType: .relative),
    Character.V.rawValue: VerticalLineTo(pathType: .absolute),
    Character.v.rawValue: VerticalLineTo(pathType: .relative),
    Character.Q.rawValue: QuadraticCurveTo(pathType: .absolute),
    Character.q.rawValue: QuadraticCurveTo(pathType: .relative),
    Character.T.rawValue: SmoothQuadraticCurveTo(pathType: .absolute),
    Character.t.rawValue: SmoothQuadraticCurveTo(pathType: .relative),
]
...
struct PathDLexer: IteratorProtocol, Sequence {
    ...
    mutating func next() -> Element? {
        ...
        while self.iteratorIndex < self.workingString.count - 1 {
            ...
            case Character.comma.rawValue, Character.sign.rawValue, Character.space.rawValue:
